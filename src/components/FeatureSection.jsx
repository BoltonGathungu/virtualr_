  ...
  return (
   <div className="relative mt-20 border-b border-neutral-800 min-h-[800px]">
    <div className="text-center">
      ...
      h-6 text-sm font-medium px-2 py-1 uppercase">Feature
      </span>
      <h2 className="text-3xl sm:text-5xl lg: 6xl mt-10 lg:mt-20 
      tracking wide">
        Easily build 
    ...
    <div className="flex flex-wrap mt-10 lg:mt-20">
      ...
      <div key={index} className="w-full lg:w-1/3 sm:1/2 ">
          ...
          <div className="flex">
            <div className="mx-6 h-10 w-10 p-2 bg-neutral-900
